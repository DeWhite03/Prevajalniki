...
public class Graph {
    ...
    private HashMap<IMC.TEMP, Node> temporaryMappings;

    public Graph() {
        nodes = new HashSet<Node>();
        temporaryMappings = new HashMap<IMC.TEMP, Node>();
    }
    ...
    public Node getNode(IMC.TEMP temporary) {
        return this.temporaryMappings.get(temporary);
    }

    public Node addNode(IMC.TEMP temporary) {
    ...
    public void removeNode(IMC.TEMP temporary) {
    ...
    public void addEdge(IMC.TEMP first, IMC.TEMP second) {
    ...
    public void removeEdge(IMC.TEMP first, IMC.TEMP second) {
        Node firstNode = this.getNode(first);
        Node secondNode = this.getNode(second);
